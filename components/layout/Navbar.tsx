...
const navigation = [
  ...
  { name: 'Admin', href: '/admin' }, // Thêm tab Admin trực tiếp vào mảng navigation
];

export default function Navbar() {
  const [isOpen, setIsOpen] = useState(false);
  const pathname = usePathname();
  const isLoggedIn = false; // Giữ nguyên trạng thái này để sử dụng sau

  // Sử dụng navigation trực tiếp, không cần điều kiện lọc dựa trên isLoggedIn
